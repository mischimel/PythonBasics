...
# The program should generate seven random numbers.txt, each in the range of 0 through 9,
# and assign each number to a list element. (Random numbers.txt were discussed in Chapter 5.)
...
def main():
    ...
    # For loop to generate the random numbers.txt and to add them to the list
    ...
    for num in lottery_number:
        print(num,end=" ") # print the numbers.txt only seperated with a " "
