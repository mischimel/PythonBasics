...
print(f"The Maximum of the three numbers.txt: {num_1}, {num_2}, and {num_3} is \n{max(num_1, num_2, num_3)}.")
print(f"The Minimum of the three numbers.txt: {num_1}, {num_2}, and {num_3} is \n{min(num_1, num_2, num_3)}.")
...
def is_max(num_a, num_b,num_c):
    if num_a > num_b and num_a > num_c:
        ...
        return "numbers.txt are identical"
