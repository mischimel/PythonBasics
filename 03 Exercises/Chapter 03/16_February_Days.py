...
# Write a program that asks the user to enter a year. The program should then display
...
if year%100 == 0 and year%400 == 0:
    print(f"{year} is a leap year, therefore February {year} has 29 days.")
elif year%4 == 0:
    print(f"{year} is a leap year, therefore February {year} has 29 days.")
else:
    print(f"{year} is not a leap year, therefore February {year} has 28 days.")