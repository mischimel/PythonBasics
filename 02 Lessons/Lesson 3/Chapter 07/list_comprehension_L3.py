...
# the following (list_using_comp = [xyz]) is good for the exam
# list_using_comp = new list
# var for var in input_list if var % 2 == 0] = add the ones from list input_list, when var%==0 is true
...
# [var ** 2 for var in range(1,10)] = adding all values^2 (values are from 1 to 9)
list_using_comp = [var ** 2 for var in range(1, 10)]

print("Output List using list comprehension:",
      list_using_comp)

# Computing the numbers.txt less than 100, which are divisible by 2 and 5 both
...
# Computing prime numbers.txt up to 100
